...
Client.prototype.methodCall = function(method, params, callback) {
	...
	// Check if request is larger than 1024 Kbytes (limit of maniaplanet)
	if (xml.length > 1024*1024-8) {
